                        ...
                        {[
                            ...
                            >
                                ...
                                <p className="text-sm text-supporting-text mt-2">
                                    Specialized deployment models designed
                                    specifically for {target.toLowerCase()}.
                                </p>
                            </div>
                        ))}
                    </div>
            ...
            <section className="py-20 bg-slate-900 text-white text-center">
                <div className="max-w-3xl mx-auto px-6">
                    ...
                    <p className="text-slate-400 text-lg mb-10">
                        Contact our Lagos headquarters today to discuss a
                        customized {service.title.toLowerCase()} plan.
                    </p>
