...
import { AccountRoleUnion } from "../unions";

export const checkSignupUserExists = mutation({
    args: {
        email: v.string(),
        ...
        try {
            ...
            if (profile) {
                throw new CustomError(
                    "Account exists already. Please check credentials or contact admin for an invite."
                );
            }
            return {
                status: true,
